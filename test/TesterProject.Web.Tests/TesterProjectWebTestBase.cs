...
using TesterProject.Models.TokenAuth;
...
{
    public abstract class TesterProjectWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static TesterProjectWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(TesterProjectWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<TesterProjectDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<TesterProjectDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<TesterProjectDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<TesterProjectDbContext, Task<T>> func)
        {
            T result;
